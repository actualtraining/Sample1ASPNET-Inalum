<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="SampleMasterPage.WebForm1" %>
    ...
    <form id="form1" runat="server">
        <div>
            <asp:SqlDataSource runat="server" ID="sdsKategori" 
                ...
                SelectCommand="SELECT * FROM [Kategori]" />
            <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="1024" BackColor="" ShowExportControls="true" ShowToolBar="true"
